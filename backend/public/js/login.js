...
function toggleLoginForm(){
    let toggleLoginFormButton= document.querySelector(".toggleLoginForm");
   let signupFormContainer = document.querySelector(".login-formContainer");
   ...
   // signupFormwrapper.style.display = "none";
    toggleLoginFormButton.style.display="block";
  ...
  //  signupFormwrapper.style.display = "flex";
    toggleLoginFormButton.style.display="none"
